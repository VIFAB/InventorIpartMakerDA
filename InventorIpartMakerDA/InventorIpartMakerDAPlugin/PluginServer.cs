...
namespace InventorIpartMakerDAPlugin
{
    [Guid("5d4b3e39-f1f6-45bc-b401-5aada04bfb77")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": InventorIpartMakerDAPlugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": InventorIpartMakerDAPlugin: deactivating... ");
